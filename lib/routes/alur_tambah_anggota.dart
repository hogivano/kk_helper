...
class AlurTambahAnggota extends StatefulWidget {
  final FirebaseUser firebaseUser;
  const AlurTambahAnggota({Key key, @required this.firebaseUser})
      : assert(firebaseUser != null),
        super(key: key);
  @override
  State<StatefulWidget> createState() => _AlurTambahAnggotaState();
}

class _AlurTambahAnggotaState extends State<AlurTambahAnggota> {
                  ...
                  new Container(
                    ...
                    child: new Row(
                      ...
                      children: <Widget>[
                        ...
                        new Container(
                          width: MediaQuery.of(context).size.width*0.7,
                          child: new Text("Mengisi biodata anggota yang hendak ditambahkan serta alasan penambahan ditempat "
