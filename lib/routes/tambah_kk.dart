...
//    }
  ...
  bool _cekInputForm2(){
    bool cek = true;
    for(int i = 0; i < jumlahKeluarga ; i++){
      if (_namaController[i].text == "" || _alamatSblmControlller[i].text == ""){
        if (cek){
          Fluttertoast.showToast(msg: "semua data harus diisi dengan lengkap", toastLength: Toast.LENGTH_SHORT);
        }
        cek = false;
      }
      listDataKeluarga[i].setNama = _namaController[i].text;
                  ...
                  child: new SingleChildScrollView(
                    ...
                    child: new Column(
                      ...
                      children: <Widget>[
                        new Container (
                          child: new Text(
                            posForm == 0 ?  "ALAMAT PEMOHON" : posForm == 1 ? "DATA KELUARGA" : "UPLOAD KELENGKAPAN"
                            ,textAlign: TextAlign.center,
                            style: TextStyle(
                              color: Colors.black54,
                              fontWeight: FontWeight.bold,
